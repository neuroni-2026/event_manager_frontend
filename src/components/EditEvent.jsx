            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-12">
                    <button 
                        ...
                        className="text-gray-400 hover:text-primary flex items-center gap-1.5 text-xs font-bold uppercase tracking-widest mb-4 transition-colors group"
                    >
                    ...
                    <p className="text-gray-500 mt-2 text-lg font-medium">Actualizează detaliile și conținutul experienței tale.</p>
                </div>
                    ...
                    >
                        <form onSubmit={handleSubmit} className="space-y-10">
                            ...
                            <div className="bg-white rounded-[2rem] shadow-xl shadow-gray-200/40 border border-white p-8 md:p-10">
                                <h3 className="text-lg font-bold text-gray-900 mb-8 flex items-center gap-3 border-b pb-4 border-gray-50">
                                ...
                                <div className="space-y-8">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input 
                                                    ...
                                                    className="w-full pl-12 pr-5 py-3.5 bg-gray-50/50 border-2 border-gray-50 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/5 focus:border-primary/30 transition-all outline-none font-medium text-gray-700"
                                                    required 
                                                    onChange={handleChange} 
                                                />
                                            </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea 
                                            ...
                                            className="w-full px-5 py-4 bg-gray-50/50 border-2 border-gray-50 rounded-2xl focus:bg-white focus:ring-4 focus:ring-primary/5 focus:border-primary/30 transition-all outline-none min-h-[160px] resize-none font-medium text-gray-700 leading-relaxed"
                                            required 
                                            onChange={handleChange}
                                        ></textarea>
                                    </div>
                                ...
                                <div className="space-y-8">
                                        ...
                                        <div className={`relative border-2 border-dashed rounded-3xl p-10 transition-all text-center group ${formData.imageUrl ? 'border-primary/30 bg-primary/5' : 'border-gray-100 hover:border-primary/30 hover:bg-gray-50'}`}>
                                            ...
                                            {uploading ? (
                                                <div className="flex flex-col items-center justify-center py-4">
                                                    ...
                                                    <span className="text-sm font-medium text-gray-500">Se actualizează imaginea...</span>
                                                </div>
                                            ) : formData.imageUrl ? (
                                                ...
                                                <label htmlFor="file-upload" className="cursor-pointer flex flex-col items-center justify-center py-6">
                                                    ...
                                                    <span className="text-gray-900 font-bold text-xl">Încarcă Imagine</span>
                                                </label>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                         <div className="flex justify-between items-center mb-2 px-1">
                                             <label className="text-xs font-bold text-gray-400 uppercase tracking-widest">Materiale Atașate</label>
                                             <label className="text-xs font-bold text-blue-600 cursor-pointer hover:bg-blue-50 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1.5 border border-blue-100">
                                         ...
                                         <div className="bg-gray-50/50 border-2 border-gray-50 rounded-[2rem] p-6 min-h-[100px]">
                                            {materials.length === 0 ? (
                                                <div className="flex flex-col items-center justify-center py-8 text-gray-400">
                                                    <FileText className="w-10 h-10 mb-2 opacity-20" />
                                                    <p className="text-sm font-medium italic">Nu există materiale încărcate.</p>
                                                </div>
                                            ) : (
                                                <div className="grid gap-3">
                                                    {materials.map((m) => (
                                                        <div key={m.id} className="flex items-center justify-between bg-white p-4 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all group">
                                                            <div className="flex items-center gap-4 overflow-hidden">
                                                                ...
                                                                <div className="flex flex-col min-w-0">
                                                                    <a href={m.fileUrl} target="_blank" rel="noopener noreferrer" className="text-sm font-bold text-gray-900 truncate hover:text-primary transition-colors">
                                                                        {m.fileName}
                                                                    </a>
                                                                    <span className="text-[10px] text-gray-400 font-bold uppercase tracking-tighter">{m.fileType?.split('/').pop() || 'FILE'}</span>
                                                                </div>
                                                            </div>
                                                            <button 
                                                                type="button" 
                            ...
                            <div className="flex items-center gap-4 pt-6">
                                ...
                                <button 
                                    type="button"
                                    onClick={() => navigate('/my-events')}
                                    className="px-8 py-3.5 bg-gray-100 hover:bg-gray-200 text-gray-600 font-bold rounded-2xl text-xs uppercase tracking-widest transition-all"
                                >
                                    Anulează
                                </button>
                            </div>
