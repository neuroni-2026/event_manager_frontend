            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-12 text-center max-w-2xl mx-auto">
                    <motion.h1 
                        ...
                        className="text-3xl md:text-5xl font-bold text-foreground tracking-tight mb-3"
                    >
                        ...
                        <form onSubmit={handleSubmit} className="space-y-10">
                                ...
                                <div className="space-y-8">
                                    <div className="space-y-2">
                                        ...
                                        <input 
                                            type="text" 
                                            name="title" 
                                            className="w-full px-5 py-3.5 bg-background border-2 border-border rounded-2xl focus:bg-card focus:ring-4 focus:ring-primary/5 focus:border-primary/30 transition-all outline-none font-medium text-foreground placeholder:text-muted-foreground" 
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="relative">
                                                ...
                                                <input 
                                                    type="text" 
                                                    name="location" 
                                                    className="w-full pl-12 pr-5 py-3.5 bg-background border-2 border-border rounded-2xl focus:bg-card focus:ring-4 focus:ring-primary/5 focus:border-primary/30 transition-all outline-none font-medium text-foreground placeholder:text-muted-foreground"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea 
                                            name="description" 
                                            className="w-full px-5 py-4 bg-background border-2 border-border rounded-2xl focus:bg-card focus:ring-4 focus:ring-primary/5 focus:border-primary/30 transition-all outline-none min-h-[160px] resize-none font-medium text-foreground placeholder:text-muted-foreground leading-relaxed"
                            ...
                            <div className="bg-card rounded-[2rem] shadow-xl shadow-black/5 border border-border p-8 md:p-10">
                                ...
                                <div className="space-y-8">
                                        ...
                                        <div className={`relative border-2 border-dashed rounded-3xl p-10 transition-all text-center group ${formData.imageUrl ? 'border-primary/30 bg-primary/5' : 'border-border hover:border-primary/30 hover:bg-muted'}`}>
                                            ...
                                            {uploading ? (
                                                <div className="flex flex-col items-center justify-center py-4">
                                                    ...
                                                    <span className="text-sm font-medium text-muted-foreground">Se urcă imaginea...</span>
                                                </div>
                                            ) : formData.imageUrl ? (
                                                ...
                                                <label htmlFor="file-upload" className="cursor-pointer flex flex-col items-center justify-center py-6">
                                                    ...
                                                    <span className="text-foreground font-bold text-xl">Alege o imagine</span>
                                                    <span className="text-muted-foreground text-sm mt-2 font-medium">Recomandat: 16:9, max 5MB</span>
                                                </label>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    {/* Materials Upload */}
                                    <div className="space-y-3">
                                         <label className="text-xs font-bold text-muted-foreground uppercase tracking-widest ml-1">Materiale Suport (PDF, DOCX)</label>
                                         <div className="bg-muted/30 border-2 border-border rounded-[2rem] p-6">
                                            <input 
                                                type="file" 
                                                multiple 
                                                onChange={handleMaterialsChange}
                                                className="block w-full text-sm text-muted-foreground file:mr-6 file:py-2.5 file:px-6 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-foreground file:text-background file:shadow-lg hover:file:bg-foreground/90 cursor-pointer transition-all"
                                            />
                                            {materials.length > 0 && (
                                                <div className="mt-6 grid gap-3">
                                                    {materials.map((file, index) => (
                                                        <div key={index} className="flex items-center justify-between bg-card p-4 rounded-2xl border border-border shadow-sm group">
                                                            <div className="flex items-center gap-4 overflow-hidden">
                                                                ...
                                                                <div className="flex flex-col min-w-0">
                                                                    ...
                                                                    <span className="text-[10px] text-muted-foreground font-bold uppercase tracking-tighter">{(file.size / 1024).toFixed(1)} KB</span>
                                                                </div>
                                                            </div>
                                                            <button type="button" onClick={() => removeMaterial(index)} className="p-2 text-muted-foreground hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-all">
                                                                <X className="w-5 h-5" />
                                                            </button>
                                                        </div>
                                                    ))}
